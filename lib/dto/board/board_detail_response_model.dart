...
class BoardDetailResponseModel {
  ...
  BoardDetailResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    hashtagList = (json['data3'] as List<dynamic>?)?.map((item) => Hashtag.fromJson(item)).toList(); // data3에서 해시태그 리스트 추출
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['data3'] = hashtagList?.map((hashname) => hashname.toJson()).toList(); // 댓글 리스트를 data2에 포함
    return _data;
  }
}
